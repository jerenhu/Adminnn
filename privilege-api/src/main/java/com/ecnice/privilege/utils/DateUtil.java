...
public class DateUtil {
	...
	public static void main(String[] args) throws Exception {
		SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd");
		System.err.println(diffDate(sdf.parse("2016-05-12"),sdf.parse(sdf.format(new Date()))));
		
		System.err.println(new SimpleDateFormat("yyyy-MM-dd").format(addMonth(new Date(), 1)));
