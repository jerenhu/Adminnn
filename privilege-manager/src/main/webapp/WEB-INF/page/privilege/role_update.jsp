        ...
        <div style="margin:20px auto;">
            <table class="form-tb" width="100%">
                ...
                <tr>
                    ...
                    <td>    
                        <select id="jsRoleLevel" name="roleLevel" class="easyui-combobox" data-options="editable:false,prompt:'请选择...',required:true,missingMessage:'请选择职责等级！'" style="width:300px">
	                        <c:choose >
                ...
                <tr>
                    ...
                    <td>    
                        <select id="jsSystemId" class="easyui-combobox" data-options="editable:false,required:true,onSelect:role.selectedSystem,prompt:'请选择...',missingMessage:'请选择所属系统！'" name="systemId" style="width:300px;">
	                        <c:choose >
